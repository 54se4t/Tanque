...
public class Arkanoid extends JFrame implements KeyListener {
	...
	private static final long serialVersionUID = 1L;  //No usado
	...
	class Ball extends GameObject {
		...
		//Para calcular da distancia entre la pelota y la ventana
		double left() {
			return x - radius;
		}
	...
	//Cambiar el sentido de la pelota
	...
	void run() {
		...
		// al pulsar ESC, no es solo parar el juego sino salir de la ventana
